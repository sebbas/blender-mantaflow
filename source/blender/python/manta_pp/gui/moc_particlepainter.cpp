...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Manta__ParticlePainter_t, stringdata) + ofs \
...
const QMetaObject Manta::ParticlePainter::staticMetaObject = {
    { &LockedObjPainter::staticMetaObject, qt_meta_stringdata_Manta__ParticlePainter.data,
      qt_meta_data_Manta__ParticlePainter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Manta__ParticlePainter.stringdata))
