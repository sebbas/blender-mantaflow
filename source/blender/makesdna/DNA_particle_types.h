...
#define PART_MANTA_SPRAY				5
#define PART_MANTA_BUBBLE				6
#define PART_MANTA_FOAM					7
#define PART_MANTA_TRACER				8
#define PART_MANTA_SPRAY_FOAM			9
#define PART_MANTA_SPRAY_BUBBLE			10
#define PART_MANTA_FOAM_BUBBLE			11
#define PART_MANTA_SPRAY_FOAM_BUBBLE	12
