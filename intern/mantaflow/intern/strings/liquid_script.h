...
tauMin_wc_s$ID$      = $SNDPARTICLE_TAUMIN_WC$\n\
tauMax_wc_s$ID$      = $SNDPARTICLE_TAUMAX_WC$\n\
tauMin_ta_s$ID$      = $SNDPARTICLE_TAUMIN_TA$\n\
tauMax_ta_s$ID$      = $SNDPARTICLE_TAUMAX_TA$\n\
tauMin_k_s$ID$       = $SNDPARTICLE_TAUMIN_K$\n\
tauMax_k_s$ID$       = $SNDPARTICLE_TAUMAX_K$\n\
