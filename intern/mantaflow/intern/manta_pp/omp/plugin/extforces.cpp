  ...
  FOR_IJK(flags)
  {
    if (flags.isOutflow(i, j, k)) {
      flags(i, j, k) =
          ...
          ~FlagGrid::
              TypeFluid;  // make sure there is not fluid flag set and to reset the empty flag
