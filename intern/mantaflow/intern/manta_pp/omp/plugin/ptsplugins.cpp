...
#pragma omp parallel 
 {  
#pragma omp for  
  for (IndexInt i = 0; i < _sz; i++) op(i,ptype,part,mark,stype,flags,cflag);  }   } ParticleDataImpl<int> & ptype; const BasicParticleSystem& part; const int mark; const int stype; const FlagGrid& flags; const int cflag;   };
#line 58 "plugin/ptsplugins.cpp"
