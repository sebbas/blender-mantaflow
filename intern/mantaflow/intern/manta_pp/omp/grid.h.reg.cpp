...
namespace Manta {
#ifdef _C_FlagGrid
static const Pb::Register _R_10("FlagGrid", "FlagGrid", "Grid<int>");
...
#endif
#ifdef _C_Grid
static const Pb::Register _R_16("Grid<int>", "Grid<int>", "GridBase");
...
static const Pb::Register _R_40("Grid<Real>", "Grid<Real>", "GridBase");
...
static const Pb::Register _R_64("Grid<Vec3>", "Grid<Vec3>", "GridBase");
...
#endif
#ifdef _C_GridBase
static const Pb::Register _R_88("GridBase", "GridBase", "PbClass");
template<> const char *Namify<GridBase>::S = "GridBase";
static const Pb::Register _R_89("GridBase", "GridBase", GridBase::_W_0);
#endif
#ifdef _C_MACGrid
static const Pb::Register _R_90("MACGrid", "MACGrid", "Grid<Vec3>");
