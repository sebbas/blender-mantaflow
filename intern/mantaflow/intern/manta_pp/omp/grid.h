...
template<class T> class Grid : public GridBase {
 public:
  ...
  static int _W_1(PyObject *_self, PyObject *_linargs, PyObject *_kwds)
  {
    PbClass *obj = Pb::objFromPy(_self);
    if (obj)
      delete obj;
...
class MACGrid : public Grid<Vec3> {
 public:
  ...
  static int _W_24(PyObject *_self, PyObject *_linargs, PyObject *_kwds)
  {
    PbClass *obj = Pb::objFromPy(_self);
    if (obj)
      delete obj;
...
class FlagGrid : public Grid<int> {
 public:
  ...
  static int _W_26(PyObject *_self, PyObject *_linargs, PyObject *_kwds)
  {
    PbClass *obj = Pb::objFromPy(_self);
    if (obj)
      delete obj;
  ...
  void updateFromLevelset(LevelsetGrid &levelset, LevelsetGrid *obsLevelset = NULL);
  static PyObject *_W_28(PyObject *_self, PyObject *_linargs, PyObject *_kwds)
  {
    try {
      ...
      PyObject *_retval = 0;
      {
        ...
        LevelsetGrid *obsLevelset = _args.getPtrOpt<LevelsetGrid>("obsLevelset", 1, NULL, &_lock);
        pbo->_args.copy(_args);
        _retval = getPyNone();
        pbo->updateFromLevelset(levelset, obsLevelset);
        pbo->_args.check();
      }
...
template<class T, class S> struct gridScaledAdd : public KernelBase {
  ...
  inline void op(IndexInt idx, Grid<T> &me, const Grid<T> &other, const S &factor)
  {
