...
// To control number of cylinders in each dimension adjust radius(0.25=>2 cyl, 0.1666=>3 cyl, 0.125=>3cyl etc.).
 ...
 struct knFlipSampleSecondaryParticlesMoreCylinders : public KernelBase { knFlipSampleSecondaryParticlesMoreCylinders( const FlagGrid &flags, const MACGrid &v, BasicParticleSystem &pts_sec, ParticleDataImpl<Vec3> &v_sec, ParticleDataImpl<Real> &l_sec, const Real lMin, const Real lMax, const Grid<Real> &potTA, const Grid<Real> &potWC, const Grid<Real> &potKE, const Real k_ta, const Real k_wc, const Real dt, const int itype = FlagGrid::TypeFluid) :  KernelBase(&flags,0) ,flags(flags),v(v),pts_sec(pts_sec),v_sec(v_sec),l_sec(l_sec),lMin(lMin),lMax(lMax),potTA(potTA),potWC(potWC),potKE(potKE),k_ta(k_ta),k_wc(k_wc),dt(dt),itype(itype)   { runMessage(); run(); }  inline void op(int i, int j, int k,  const FlagGrid &flags, const MACGrid &v, BasicParticleSystem &pts_sec, ParticleDataImpl<Vec3> &v_sec, ParticleDataImpl<Real> &l_sec, const Real lMin, const Real lMax, const Grid<Real> &potTA, const Grid<Real> &potWC, const Grid<Real> &potKE, const Real k_ta, const Real k_wc, const Real dt, const int itype = FlagGrid::TypeFluid )  {
...
}   inline const FlagGrid& getArg0() { return flags; } typedef FlagGrid type0;inline const MACGrid& getArg1() { return v; } typedef MACGrid type1;inline BasicParticleSystem& getArg2() { return pts_sec; } typedef BasicParticleSystem type2;inline ParticleDataImpl<Vec3> & getArg3() { return v_sec; } typedef ParticleDataImpl<Vec3>  type3;inline ParticleDataImpl<Real> & getArg4() { return l_sec; } typedef ParticleDataImpl<Real>  type4;inline const Real& getArg5() { return lMin; } typedef Real type5;inline const Real& getArg6() { return lMax; } typedef Real type6;inline const Grid<Real> & getArg7() { return potTA; } typedef Grid<Real>  type7;inline const Grid<Real> & getArg8() { return potWC; } typedef Grid<Real>  type8;inline const Grid<Real> & getArg9() { return potKE; } typedef Grid<Real>  type9;inline const Real& getArg10() { return k_ta; } typedef Real type10;inline const Real& getArg11() { return k_wc; } typedef Real type11;inline const Real& getArg12() { return dt; } typedef Real type12;inline const int& getArg13() { return itype; } typedef int type13; void runMessage() { debMsg("Executing kernel knFlipSampleSecondaryParticlesMoreCylinders ", 3); debMsg("Kernel range" <<  " x "<<  maxX  << " y "<< maxY  << " z "<< minZ<<" - "<< maxZ  << " "   , 4); }; void run() {  const int _maxX = maxX; const int _maxY = maxY; for (int k=minZ; k< maxZ; k++) for (int j=0; j< _maxY; j++) for (int i=0; i< _maxX; i++) op(i,j,k, flags,v,pts_sec,v_sec,l_sec,lMin,lMax,potTA,potWC,potKE,k_ta,k_wc,dt,itype);  } const FlagGrid& flags; const MACGrid& v; BasicParticleSystem& pts_sec; ParticleDataImpl<Vec3> & v_sec; ParticleDataImpl<Real> & l_sec; const Real lMin; const Real lMax; const Grid<Real> & potTA; const Grid<Real> & potWC; const Grid<Real> & potKE; const Real k_ta; const Real k_wc; const Real dt; const int itype;   };
...
}   inline const FlagGrid& getArg0() { return flags; } typedef FlagGrid type0;inline const MACGrid& getArg1() { return v; } typedef MACGrid type1;inline BasicParticleSystem& getArg2() { return pts_sec; } typedef BasicParticleSystem type2;inline ParticleDataImpl<Vec3> & getArg3() { return v_sec; } typedef ParticleDataImpl<Vec3>  type3;inline ParticleDataImpl<Real> & getArg4() { return l_sec; } typedef ParticleDataImpl<Real>  type4;inline const Real& getArg5() { return lMin; } typedef Real type5;inline const Real& getArg6() { return lMax; } typedef Real type6;inline const Grid<Real> & getArg7() { return potTA; } typedef Grid<Real>  type7;inline const Grid<Real> & getArg8() { return potWC; } typedef Grid<Real>  type8;inline const Grid<Real> & getArg9() { return potKE; } typedef Grid<Real>  type9;inline const Real& getArg10() { return k_ta; } typedef Real type10;inline const Real& getArg11() { return k_wc; } typedef Real type11;inline const Real& getArg12() { return dt; } typedef Real type12;inline const int& getArg13() { return itype; } typedef int type13; void runMessage() { debMsg("Executing kernel knFlipSampleSecondaryParticles ", 3); debMsg("Kernel range" <<  " x "<<  maxX  << " y "<< maxY  << " z "<< minZ<<" - "<< maxZ  << " "   , 4); }; void run() {  const int _maxX = maxX; const int _maxY = maxY; for (int k=minZ; k< maxZ; k++) for (int j=0; j< _maxY; j++) for (int i=0; i< _maxX; i++) op(i,j,k, flags,v,pts_sec,v_sec,l_sec,lMin,lMax,potTA,potWC,potKE,k_ta,k_wc,dt,itype);  } const FlagGrid& flags; const MACGrid& v; BasicParticleSystem& pts_sec; ParticleDataImpl<Vec3> & v_sec; ParticleDataImpl<Real> & l_sec; const Real lMin; const Real lMax; const Grid<Real> & potTA; const Grid<Real> & potWC; const Grid<Real> & potKE; const Real k_ta; const Real k_wc; const Real dt; const int itype;   };
...
void flipSampleSecondaryParticles( const std::string mode, const FlagGrid &flags, const MACGrid &v, BasicParticleSystem &pts_sec, ParticleDataImpl<Vec3> &v_sec, ParticleDataImpl<Real> &l_sec, const Real lMin, const Real lMax, const Grid<Real> &potTA, const Grid<Real> &potWC, const Grid<Real> &potKE, const Real k_ta, const Real k_wc, const Real dt, const int itype = FlagGrid::TypeFluid) {
	if (mode == "single") {
		knFlipSampleSecondaryParticles(flags, v, pts_sec, v_sec, l_sec, lMin, lMax, potTA, potWC, potKE, k_ta, k_wc, dt, itype);
	}
	else if (mode == "multiple") {
		knFlipSampleSecondaryParticlesMoreCylinders(flags, v, pts_sec, v_sec, l_sec, lMin, lMax, potTA, potWC, potKE, k_ta, k_wc, dt, itype);
	}
	else {
