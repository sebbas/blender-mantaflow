...
//	void run_manta_sim_file_highRes(SmokeModifierData *smd);
	...
	void update_pointers(FLUID_3D *fluid);
	void update_high_res_pointers(WTURBULENCE *wt);
}
...
//	
//	static std::string get_real_value(const string& varName, SmokeModifierData *sds);
//	
...
//	
//	static void * pointer_from_string(const std::string& s);
//	
...
//	
//	static std::string get_grid_pointer(string gridName, string solverName);
//	static void update_pointers(FLUID_3D *fluid);
//	static void update_high_res_pointers(WTURBULENCE *wt);
