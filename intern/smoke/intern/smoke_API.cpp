...
extern "C" void smoke_dissolve(Manta_API *fluid, int speed, int log)
{
...
extern "C" void smoke_export(Manta_API *fluid, float *dt, float *dx, float **dens, float **react, float **flame, float **fuel, float **heat, 
...
extern "C" float *smoke_get_density(Manta_API *fluid)
{
	return fluid->_density;
}

extern "C" float *smoke_get_fuel(Manta_API *fluid)
{
	return NULL;//fluid->_fuel;
}

extern "C" float *smoke_get_react(Manta_API *fluid)
{
	return NULL;//fluid->_react;
}

extern "C" float *smoke_get_heat(Manta_API *fluid)
{
	return NULL;//fluid->_heat;
}

extern "C" float *smoke_get_velocity_x(Manta_API *fluid)
{
	return fluid->_xVelocity;
}

extern "C" float *smoke_get_velocity_y(Manta_API *fluid)
{
	return fluid->_yVelocity;
}

extern "C" float *smoke_get_velocity_z(Manta_API *fluid)
{
	return fluid->_zVelocity;
}

extern "C" float *smoke_get_force_x(Manta_API *fluid)
{
	return fluid->_xForce;
}

extern "C" float *smoke_get_force_y(Manta_API *fluid)
{
	return fluid->_yForce;
}

extern "C" float *smoke_get_force_z(Manta_API *fluid)
{
	return fluid->_zForce;
}

extern "C" float *smoke_get_flame(Manta_API *fluid)
{
	return NULL;//fluid->_flame;
}

extern "C" float *smoke_get_color_r(Manta_API *fluid)
{
	return NULL;//fluid->_color_r;
}

extern "C" float *smoke_get_color_g(Manta_API *fluid)
{
	return NULL;//fluid->_color_g;
}

extern "C" float *smoke_get_color_b(Manta_API *fluid)
{
	return NULL;//fluid->_color_b;
}
...
extern "C" void smoke_get_rgba(Manta_API *fluid, float *data, int sequential)
{
...
extern "C" void smoke_get_rgba_from_density(Manta_API *fluid, float color[3], float *data, int sequential)
{
...
extern "C" unsigned char *smoke_get_obstacle(Manta_API *fluid)
{
	return fluid->_obstacles;
}

extern "C" void smoke_get_ob_velocity(Manta_API *fluid, float **x, float **y, float **z)
{
...
extern "C" int smoke_has_heat(Manta_API *fluid)
{
	return 0;//(fluid->_heat) ? 1 : 0;
}

extern "C" int smoke_has_fuel(Manta_API *fluid)
{
	return 0;//(fluid->_fuel) ? 1 : 0;
}

extern "C" int smoke_has_colors(Manta_API *fluid)
{
	return 0;//(fluid->_color_r && fluid->_color_g && fluid->_color_b) ? 1 : 0;
}
...
extern "C" void smoke_ensure_heat(Manta_API *fluid)
{
//	if (fluid) {
//		fluid->initHeat();
//	}
...
extern "C" void smoke_ensure_fire(Manta_API *fluid, WTURBULENCE *wt)
{
//	if (fluid) {
//		fluid->initFire();
//	}
...
extern "C" void smoke_ensure_colors(Manta_API *fluid, WTURBULENCE *wt, float init_r, float init_g, float init_b)
{
//	if (fluid) {
