...
class PHYSICS_PT_smoke_secondary_particles(PhysicButtonsPanel, Panel):
    ...
    def draw(self, context):
        ...
        sub1 = first.column()
        sub2 = sub1.row()
        sub2.prop(domain, "use_drop_particles", text="Spray")
        sub2.prop(domain, "use_floater_particles", text="Foam")
        sub3 = sub1.row()
        sub3.prop(domain, "use_bubble_particles", text="Bubbles")
        sub3.prop(domain, "use_flip_particles", text="FLIP")
        sub4 = first.column()
        sub4.active = domain.use_drop_particles or domain.use_floater_particles or domain.use_bubble_particles
        sub4.label(text="Potential Clamping:")
        sub4.prop(domain, "sndparticle_tau_min_wc", text="tauMin_wc")
        sub4.prop(domain, "sndparticle_tau_max_wc", text="tauMax_wc")
        sub4.prop(domain, "sndparticle_tau_min_ta", text="tauMin_ta")
